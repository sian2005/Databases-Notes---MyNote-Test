...
function run(args) {
    if (window.ObsHtmlGraph.graph_dependencies_loaded['2d'] == false){
        ...
        load_script_on_demand(
            '/Databases-Notes---MyNote-Test//unpkg.com/force-graph', load_script_on_demand, ["/Databases-Notes---MyNote-Test//unpkg.com/d3-force", load_script_on_demand, ["https://d3js.org/d3.v4.min.js", initGraph, [args]]]
        )
